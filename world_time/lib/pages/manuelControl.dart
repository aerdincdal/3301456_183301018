...
class ManuelControl extends StatefulWidget {
  const ManuelControl({Key? key}) : super(key: key);

  @override
  State<ManuelControl> createState() => _ManuelControlState();
}

class _ManuelControlState extends State<ManuelControl> {
  @override
                  ...
                  Expanded(
                    ...
                    child: Align(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget> [
                            Text("Need to add Manuel Control!",
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
