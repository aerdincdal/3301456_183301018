...
class FieldBorders extends StatefulWidget {
  const FieldBorders({Key? key}) : super(key: key);

  @override
  State<FieldBorders> createState() => _FieldBordersState();
}

class _FieldBordersState extends State<FieldBorders> {
  @override
                  ...
                  Expanded(
                    ...
                    child: Align(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget> [
                            Text("Here lies a perished soul who tried to change borders of the field!",
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
