...
class FlowSettings extends StatefulWidget {
  const FlowSettings({Key? key}) : super(key: key);

  @override
  State<FlowSettings> createState() => _FlowSettingsState();
}

class _FlowSettingsState extends State<FlowSettings> {
                  ...
                  Expanded(
                    ...
                    child: Align(
                        ...
                        child: Column(
                          ...
                          children: <Widget> [
                            SettingUnit(
                              settingDescription: "Enable Semi-Open Spraying",
                              settingState: false,
                              onChanged: (bool value) {
                              },
                            ),
                            SettingUnit(
                              settingDescription: "Enable Automated Section Control",
                              settingState: true,
                              onChanged: (bool value) {
                              },
                            ),
                            SettingUnit(
                              settingDescription: "Start Spraying at Reserve Land",
                              settingState: false,
                              onChanged: (bool value) {
                              },
                            ),
